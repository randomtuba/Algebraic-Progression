...
const ACHIEVEMENTS = {
  ...
  8: {
    ...
    done(){return player.points.gte(1e15) && !isNaN(player.points)},
  },
  9: {
    name: "(softcapped)",
  ...
  15: {
    ...
    done(){return player.points.gte(1e100) && !isNaN(player.points)},
  },
  16: {
  ...
  17: {
    ...
    done(){return player.points.gte(1.79e308) && !isNaN(player.points)},
  },
  18: {
  ...
  60: {
    ...
    done(){return player.points.gte("1e5e8") && !isNaN(player.points)},
  },
}
